...
if __name__ == "__main__":
    ...
    if model is not None and tokenizer is not None:
        # Exemple de test
         ...
         context = """Le traitement du diabète de type 2 repose sur plusieurs approches complémentaires. 
La première ligne de traitement comprend des modifications du mode de vie, notamment 
une alimentation équilibrée et une activité physique régulière. Si ces mesures sont 
insuffisantes, des médicaments oraux comme la metformine sont généralement prescrits 
en première intention. Dans certains cas, d'autres médicaments peuvent être ajoutés, 
tels que les sulfonylurées ou les inhibiteurs de la DPP-4. Pour les cas plus 
avancés, l'insulinothérapie peut devenir nécessaire. Un suivi régulier de la 
glycémie et des consultations médicales sont essentiels pour ajuster le traitement."""
        reference_answer = "La première ligne de traitement comprend des modifications du mode de vie, notamment une alimentation équilibrée et une activité physique régulière"
        # Test de l'exemple
