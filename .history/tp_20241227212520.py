...
- num_epochs = 1 : Nombre d'époques optimal
...
def train_model(model, train_dataloader, eval_dataloader, num_epochs=1):
    """
    Entraîne le modèle
    Args:
...
def main():
    ...
    train_val_split = small_dataset["train"].train_test_split(test_size=0.1, seed=42)
