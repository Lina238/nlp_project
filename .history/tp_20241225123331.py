    ...
    def setup_peft(self):
        ...
        if self.peft_technique == "adapter":
            ...
            peft_config = LoraConfig(
                task_type=TaskType.QUESTION_ANSWERING_WITH_HEAD,  # Correction: QUESTION_ANSWERING -> QUESTION_ANSWERING_WITH_HEAD
...
def main():
    ...
    dataset = dataset["train"].select(range(1000))  # Limitation à 1000 exemples
    ...
    print(f"Example question: {sample_item['questions'][:100]}...")
