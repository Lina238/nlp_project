...
# Configurations pour supprimer les logs et warnings
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'  # Supprimer les logs de TensorFlow
os.environ['TF_ENABLE_ONEDNN_OPTS'] = '0'  # Désactiver oneDNN custom ops
warnings.filterwarnings('ignore')  # Désactiver les warnings Python
tf.get_logger().setLevel('ERROR')  # Supprimer les warnings TensorFlow
...
anxiété intense ou une sensation de mort imminente."""
        reference_answer = "Les signes les plus courants incluent une douleur thoracique intense et prolongée"
        # Test de l'exemple
